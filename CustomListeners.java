...
public abstract class CustomListeners implements EventListener
{
    ...
    public void onGuildMemberJoinByInvit(@Nonnull GuildMemberJoinByInvitEvent event) {}
    ...
    public final void onEvent(@Nonnull GenericEvent event)
    {
        ...
        if (event instanceof ReadyEvent) {
            ...
            for (Guild g : event.getJDA().getGuilds()) Main.invites.put(g, g.retrieveInvites().complete());
